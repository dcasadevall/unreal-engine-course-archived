...
#include "Section_01/Section_01GameModeBase.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// End Cross Module References
	...
	struct Z_Construct_UClass_ASection_01GameModeBase_Statics
	{
	...
	UObject* (*const Z_Construct_UClass_ASection_01GameModeBase_Statics::DependentSingletons[])() = {
		(UObject* (*)())Z_Construct_UClass_AGameModeBase,
		(UObject* (*)())Z_Construct_UPackage__Script_Section_01,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ASection_01GameModeBase_Statics::Class_MetaDataParams[] = {
		{ "Comment", "/**\n * \n */" },
...
#endif
	const FCppClassTypeInfoStatic Z_Construct_UClass_ASection_01GameModeBase_Statics::StaticCppClassTypeInfo = {
		TCppClassTypeTraits<ASection_01GameModeBase>::IsAbstract,
	};
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_ASection_01GameModeBase_Statics::ClassParams = {
		...
		0,
		0x009002ACu,
		METADATA_PARAMS(Z_Construct_UClass_ASection_01GameModeBase_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_ASection_01GameModeBase_Statics::Class_MetaDataParams))
	};
	UClass* Z_Construct_UClass_ASection_01GameModeBase()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_ASection_01GameModeBase_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(ASection_01GameModeBase, 18323349);
	template<> SECTION_01_API UClass* StaticClass<ASection_01GameModeBase>()
	{
		return ASection_01GameModeBase::StaticClass();
	}
